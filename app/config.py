...
class Config(BaseSettings):
    ...
    otel_service_name: str = Field(default="llm-gateway", alias="OTEL_SERVICE_NAME")

    service_version: str = Field(default="0.2.0", alias="SERVICE_VERSION")

    langfuse_host: str = Field(default="https://cloud.langfuse.com", alias="LANGFUSE_OTEL_HOST")
